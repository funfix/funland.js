...
exec(`./node_modules/.bin/typedoc --mode file --theme minimal --listInvalidSymbolLinks --excludeNotExported --excludePrivate --out .docs --target es6 --name ${pkg.name} --readme rootdoc.md src`)
